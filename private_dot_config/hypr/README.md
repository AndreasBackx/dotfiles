...
- `~/.config/hypr/dms/outputs.lua` is generated by DMS from its display profiles.
...
Run `dms setup outputs` during initial bootstrap, then create and validate each
physical output combination in DMS Settings before enabling automatic selection.
